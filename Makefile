...
TEST_BINS = test_circ_queue test_bst test_search test_hash_func \
            ...
            test_dijkstra test_bellman_ford test_bfs test_dfs test_topological_sort test_benchmark test_scc test_ford_fulkerson test_edmonds_karp test_dinic test_bipartite_matching test_hopcroft_karp test_eulerian_path test_binomial_heap test_fibonacci_heap test_leftist_skew_heap
